...
CORTEX_SEARCH_DOCUMENTATION = "SOPHIE_CORTEX_AGENTS_SUMMIT.PUBLIC.DOCUMENTATION_TOOL"
SEMANTIC_MODEL = "@SOPHIE_CORTEX_AGENTS_SUMMIT.PUBLIC.SEMANTIC_FILES/semantic.yaml"
